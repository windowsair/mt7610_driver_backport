...
int mt76x0_phy_get_rssi(struct mt76x0_dev *dev, struct mt76x0_rxwi *rxwi)
{
	...
	if ((int)dev->mt76.chandef.chan->band == (int)NL80211_BAND_2GHZ) {
...
void mt76x0_phy_recalibrate_after_assoc(struct mt76x0_dev *dev)
{
	...
	int is_5ghz = ((int)dev->mt76.chandef.chan->band == (int)NL80211_BAND_5GHZ) ? 1 : 0;
...
static void mt76x0_dynamic_vga_tuning(struct mt76x0_dev *dev)
{
	...
	init_vga = ((int)dev->mt76.chandef.chan->band == (int)NL80211_BAND_5GHZ) ? 0x54 : 0x4E;
	if (dev->avg_rssi > -60)
		init_vga -= 0x20;
